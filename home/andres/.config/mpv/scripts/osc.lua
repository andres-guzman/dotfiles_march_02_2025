...
local user_opts = {
    ...
    seekrangealpha = 255,       -- transparency of seekranges
    ...
    chapter_fmt = "no", -- chapter print format for seekbar-hover. "no" to disable. Defautl value "Chapter: %s"
    unicodeminus = true,       -- whether to use the Unicode minus sign character

    background_color = "#000000",     -- background color of the osc
    timecode_color = "#ccd0da",       -- color of the progress bar and time color
    title_color = "#ccd0da",          -- color of the title
    time_pos_color = "#179299",       -- color of the timecode at hovered position
    buttons_color = "#ccd0da",        -- color of big buttons, wc buttons, and bar small buttons
    small_buttonsL_color = "#ccd0da", -- color of left small buttons
    small_buttonsR_color = "#ccd0da", -- color of right small buttons
    top_buttons_color = "#ccd0da",    -- color of top buttons
    held_element_color = "#999999",   -- color of an element while held down
    time_pos_outline_color = "#179299",   -- color of the border timecodes in slimbox and TimePosBar
