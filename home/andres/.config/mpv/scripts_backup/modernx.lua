...
local user_opts = {
    ...
    scaleforcedwindow = 1,            -- scaling when rendered on a forced window. Default: 1.5
    ...
    chapter_fmt = "no",                 -- chapter print format for seekbar-hover. "no" to disable. Default: "Chapter: %s"
    ...
    showonseek = true,                 -- show OSC when seeking
    ...
    blur_intensity = 0,               -- adjust the strength of the OSC blur
...
function layout()
    ...
    lo.geometry = {x = 33, y = refY - 20, an = 5, w = 24, h = 24}
